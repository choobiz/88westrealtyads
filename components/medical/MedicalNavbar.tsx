...
const NAV_ITEMS = [
  { label: "The Building", href: "#features" },
...
export default function MedicalNavbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-med-navy h-[72px] flex items-center">
      <div className="max-w-[1200px] mx-auto w-full px-5 md:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <a href="#register" className="inline-flex items-center h-10 px-5 bg-brand-red text-white text-sm font-semibold rounded-full hover:bg-brand-red-hover transition-colors">
        ...
        <div className="flex md:hidden items-center gap-2">
          ...
          <a href="#register" className="inline-flex items-center h-9 px-4 bg-brand-red text-white text-xs font-semibold rounded-full">
            Register
          </a>
      ...
      {mobileOpen && (
        <div className="absolute top-[72px] left-0 right-0 bg-med-navy border-t border-white/20 md:hidden">
